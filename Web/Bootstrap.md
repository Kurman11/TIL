# Bootstrap
> 프론트엔드 라이브러리(Toolkit)
**반응형 웹 디자인 & CSS 및 JS기반의 컴포넌트와 스타일 제공**
...
* t : {sides}
  ...
  * s(start) : margin,padding - right
  * e(end) : margin,padding - left
  * x : 가로(수평)
  * y : 세로(수직)
...
* 사용자가 해당 서버에서 멀리 떨어져 있는 경우 해당 콘텐츠를 로드 하는 데 시간이 오래 걸림
...
3. bootstrap.css파일을 참고하여, 현재까지 작성한 클래스에 적용된 스타일을 직접 확인
