...
# 23.06.16
최종 프로젝트를 마무리했다.. 핑계지만 마지막 작성이후 매일 새벽까지 디스코드에 모여서 프로젝트를 하다보니 글 쓰는거를 까먹었다.
마지막 프로젝트 가장 재미있었고 기간이 길어서 그런지 나름 만족하는 프로젝트 였다. 물론 아쉬운게 없다면 거짓말이고 아쉬운점은 모든 기능들의 디테일을 조금만더 살렸다면 최소한 장려상은???(욕심인가)라는 받았을거 같은 느낌?? ㅎㅎ
이부분은 팀원들도 아쉬워 했고 다들 프로젝트는 끝났지만 따로 모여서 조금더 개선하는 쪽으로 이야기했다 물론 말뿐인 약속인지 봐야하지만 지금까지의 분위기는 너무 좋아서 조금만 쉬었다 다시 작업을 이어서 보안하고 작업을 시작할거같다 작업에 들어가면 일단 이메일 인증의 비동기에 대해 한번 도전하고싶다.
마무리로 6개월동안 정말 많이 재밌었던 공부였던거같다.